...
import type { ProductivityTrend as TrendData } from '../../../shared/types'
...
export default function ProductivityTrend({ data }: ProductivityTrendProps) {
  if (data.length === 0) {
    return (
      <div style={styles.container}>
        <div style={styles.title}>Productivity Trend</div>
